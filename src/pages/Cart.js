...
const Cart = () => {
    ...
    const [ priceFetched, setPricrFetched ] = useState(false);
    ...
    const handleDelete = (productId) => {
        ...
        setCart(_cart);
        const ubdatedProductList = products.filter((product) => product._id !== productId);
        setProducts(ubdatedProductList);    
    }
                    ...
                    return(
                        <li className="mb-12" key={product._id}>
                            ...
                            <div className="flex items-center">
                                <img className="h-16" src={product.image} alt="piza" />
